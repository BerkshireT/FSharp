...
\fancyhead[L]{
\noindent
    \vspace{5pt}\hspace{0pt}\large{\bf{\textcolor{DarkBackground}{\textrm{The F$^{\sharp}$ Programming Language: Quick Reference Sheet (Author: Tyler P. Berkshire)}}}} \\}
\fancyfoot[C]{\textrm{Copyright $\copyright$ 2019 by Tyler P Berkshire.}}
